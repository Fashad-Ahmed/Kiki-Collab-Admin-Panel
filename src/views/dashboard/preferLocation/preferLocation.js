    ...
    <div className="bg-color">
      <div style={{ height: '70vh', width: '100%' }}>
        ...
        >
          ...
          />
          <Marker key={1} position={[24.8607, 67.0011]}>
            <Popup>dgfgrdgrf</Popup>
          </Marker> */}
        {/* <Marker key={2} position={[31.422, 73.0923]}>
            <Popup>
              A pretty CSS3 popup. <br /> Easily customizable.
            </Popup>
          </Marker>
          <Marker key={3} position={[30.197979, 71.472498]}>
            <Popup>
              A pretty CSS3 popup. <br /> Easily customizable.
            </Popup>
          </Marker>
          <Marker key={4} position={[33.559707, 73.168945]}>
            <Popup>
              A pretty CSS3 popup. <br /> Easily customizable.
            </Popup>
          </Marker>
          <Marker key={5} position={[34.0151, 71.5249]}>
            <Popup>
              A pretty CSS3 popup. <br /> Easily customizable.
            </Popup>
          </Marker> */}
